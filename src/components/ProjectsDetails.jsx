...
const projects = [
  {
    ...
    image: "https://framerusercontent.com/images/ODJhWRk5wCb5cybdLgcKObVbwk.png" // White sweatshirt mockup vibe
  },
  {
    id: 2,
    title: "Nova Scene",
    description: "The image shows flowing shapes in iridescent hues, from deep blues and purples to vibrant pinks and oranges, creating an ethereal effect.",
    image: "https://framerusercontent.com/images/O8kqDvhJzW7n3I7u4UE4VTZIEas.png" // Perfume bottle vibe
  },
  {
    id: 3,
    title: "Abstract Flow",
    description: "The image shows flowing shapes in iridescent hues, from deep blues and purples to vibrant pinks and oranges, creating an ethereal effect.",
    image: "https://framerusercontent.com/images/JOqvhPEZu18F6qYfiLZFYW4RiBo.png" // Abstract dark/red
  },
  // {
  //   id: 4,
  //   title: "Golden Hour",
  //   description: "The image shows flowing shapes in iridescent hues, from deep blues and purples to vibrant pinks and oranges, creating an ethereal effect.",
  //   image: "https://framerusercontent.com/images/k64jd9JZg2STpec9ROq9XmXmzrs.png" // Orange fluid
  // },
  // {
  //   id: 5,
  //   title: "Fluid Shapes",
  //   description: "The image shows flowing shapes in iridescent hues, from deep blues and purples to vibrant pinks and oranges, creating an ethereal effect.",
  //   image: "https://framerusercontent.com/images/unPTlAup0AJPIvdR2osrG3Qnb0.png" // Orange fluid
  // }
];

// --- Reusable Button Component ---
const ViewButton = () => (
   <button className="group relative bg-[#242424] p-1 rounded-full flex items-center overflow-hidden min-w-[120px] h-[44px] transition-all duration-700 ease-in-out cursor-pointer">
