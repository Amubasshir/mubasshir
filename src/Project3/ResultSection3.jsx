        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/dvwjq2l7Q3WVXh7CApYHuEsx9Y.png" 
              alt="Brand Hat" 
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/NFXWQDeKDgwGxxlmOIr3nwAfog.png?scale-down-to=1024" 
              alt="Brand Tote" 
              className="w-full h-full object-cover"
            />
          </motion.div>
