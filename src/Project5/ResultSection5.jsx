        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/hQ6XzXBgqVuEI8ZXtTLutVTQI.png" 
              alt="Brand Hat" 
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/B0BoOQLoPcAANTKE19cfRzwWiZY.png" 
              alt="Brand Tote" 
              className="w-full h-full object-cover"
            />
          </motion.div>
