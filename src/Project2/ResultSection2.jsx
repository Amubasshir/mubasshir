        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/vpP1R57lGjjqjGAQ7aCEaev95Q.png?scale-down-to=1024" 
              alt="Brand Hat" 
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/dmThOJPZJN23IqaS36QHd9uG8xY.jpg?scale-down-to=1024" 
              alt="Brand Tote" 
              className="w-full h-full object-cover"
            />
          </motion.div>
