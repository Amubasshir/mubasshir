...
const DreamResultSection = () => {
  return (
    <section className="bg-[#0a0a0a] text-white py-20 px-6 md:px-12 font-sans rounded-b-[70px] relative z-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/dmGsKBU5PNvcbiVcyJaYTltb7Js.png" 
              alt="Brand Hat" 
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/DRXLOdIJeGRFKwoTPtMBjXLfg.png?scale-down-to=1024" 
              alt="Brand Tote" 
              className="w-full h-full object-cover"
            />
          </motion.div>
...
export default DreamResultSection;