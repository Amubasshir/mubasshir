        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/G7w1aH5MppBhYnFXU0L2J5MVEk.png?scale-down-to=1024" 
              alt="Brand Hat" 
          ...
          >
            <img 
              ...
              src="https://framerusercontent.com/images/cJrPyO2SB1n5VyP5KERn6I3LoA.png?scale-down-to=1024" 
              alt="Brand Tote" 
              className="w-full h-full object-cover"
            />
          </motion.div>
...
export default DreamGoalSection;